...
describe("FizzBuzz", () => {
  const standardRules: [number, string][] = [
    [3, "Fizz"],
    [5, "Buzz"],
  ];
  ...
  test("with third parameter", () => {
    expect(fizzBuzz(3, fizzBuzzReplacer, standardRules)).toEqual([
      1,
      2,
      "Fizz",
    ]);
...
describe("FizzBuzzReplacer", () => {
  ...
  test("five numbers should return array with three numbers, Fizz and Buzz", () => {
    expect(fizzBuzzReplacer([1, 2, 3, 4, 5], standardRules)).toEqual([
      1,
      2,
      "Fizz",
      4,
